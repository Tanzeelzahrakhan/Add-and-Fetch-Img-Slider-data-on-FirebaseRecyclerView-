...
*/
        holder.binding.carousel.addData(new CarouselItem(model.getName(),""));
        holder.binding.carousel.addData(new CarouselItem(model.getEmail(),""));
        holder.binding.carousel.addData(new CarouselItem(model.getPassword(),""));
        holder.binding.carousel.addData(new CarouselItem(model.getImageUrl(),""));
    }
